    ...
    <div id = 'news'>
      ...
      <div className='news__row'>
        <div className='news__row__item'>
          <img className='news__row__item__img' src = { require('../../assets/images/news/Ben_Yedder.jpg') } />
        ...
        <div className='news__row__item'>
          <img className='news__row__item__img' src = { require('../../assets/images/news/Contract_Extensions.jpg') } />
          <div className='news__row__item__full'>
            <div className='news-type'>Focus</div>
            <div className='news-timing'>December 17, 2021 -  03:24</div>
          </div>
      ...
      <div className='news__row'>
        <div className='news__row__item'>
          <img className='news__row__item__img' src = { require('../../assets/images/news/podcast_logo.png') } />
          <div className='news__row__item__full'>
            <div className='news-type'>Focus</div>
            <div className='news-timing'>December 17, 2021 -  03:24</div>
          </div>
