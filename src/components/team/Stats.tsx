...
import './team.scss';
import { PlayerInterface, TeamInterface, TeamResultsInterface } from '../../interfaces';
import FootballAPIHelpers from '../../helpers/FootballAPIHelpers';

const Stats = ({team}: { team: TeamInterface }) => {
      ...
      <div id='general'>
        ...
        <div id='team__general-stats'>
          <div className='team__general-stats__item'>
            ...
            <div id='top_scorer'><a href={'/players/' + team.top_scorers![0].id} ><img src={team.top_scorers![0]['face'] as string} alt='' /></a></div>
